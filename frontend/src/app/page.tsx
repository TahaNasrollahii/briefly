...
import { UploadCloud, FileAudio, Clock, CheckCircle, AlertCircle, Sparkles, ChevronLeft, ChevronRight } from 'lucide-react';
                ...
                <motion.div key={job.job_id} variants={itemVariants} layout>
                  ...
                  >
                    <div className="flex items-center gap-5">
                      ...
                      <div>
                        <p className="font-semibold text-white text-lg tracking-tight">{t('job')} {job.job_id.slice(0, 8)}</p>
